            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="text-right hidden sm:block">
                            <div className="text-xs font-bold uppercase tracking-widest text-gray-500">{t('dashboard.total_tokens')}</div>
                        ...
                        <button
                            ...
                            title={t('dashboard.export_image')}
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="bg-white p-6 border-4 border-black shadow-hard-md hover:-translate-y-1 hover:shadow-hard-lg transition-all">
                        ...
                        <p className="text-xs font-bold uppercase tracking-wider text-gray-500">{t('dashboard.total_projects')}</p>
                    </div>
                    <div className="bg-white p-6 border-4 border-black shadow-hard-md hover:-translate-y-1 hover:shadow-hard-lg transition-all">
                        <div className="flex justify-between items-start mb-4">
                        ...
                        <p className="text-xs font-bold uppercase tracking-wider text-gray-500">{t('dashboard.total_sessions')}</p>
                    </div>
                    <div className="bg-white p-6 border-4 border-black shadow-hard-md hover:-translate-y-1 hover:shadow-hard-lg transition-all">
                        <div className="flex justify-between items-start mb-4">
                        ...
                        <p className="text-xs font-bold uppercase tracking-wider text-gray-500">{t('dashboard.total_messages')}</p>
                    </div>
                    <div className="bg-white p-6 border-4 border-black shadow-hard-md hover:-translate-y-1 hover:shadow-hard-lg transition-all">
                        <div className="flex justify-between items-start mb-4">
                        ...
                        <p className="text-xs font-bold uppercase tracking-wider text-gray-500">{t('dashboard.top_model')}</p>
                    </div>
                </div>
                                                        ...
                                                        >
                                                            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-max hidden group-hover/cell:block z-50">
                                                                <div className="bg-black text-white text-xs font-bold px-3 py-2 border-2 border-white shadow-hard-sm text-center">
                                                                    ...
                                                                    <div>{count} {t('dashboard.msgs')}</div>
                                                                </div>
                                ...
                                return (
                                    ...
                                    >
                                        <div className="hidden group-hover:block absolute z-50 bg-black text-white text-xs p-2 whitespace-nowrap shadow-hard-sm border-2 border-white bottom-full left-1/2 -translate-x-1/2 mb-1 pointer-events-none" style={{ transform: `rotate(${-hour.angle}deg)` }}>
                                            <span className="font-mono font-bold text-primary-yellow">{hour.hour}:00</span> - {hour.count} {t('dashboard.msgs')}
                                        </div>
                                    </div>
                                )
                            })}
                                ...
                                >
                                    ...
                                    <div className="flex flex-col gap-0.5 items-center justify-end w-full pb-1">
                                        <div className="text-[8px] font-bold text-gray-400 rotate-0 whitespace-nowrap leading-none scale-75 origin-bottom">
                                            {t('dashboard.session')}:{day.sessions}
                                        </div>
                                        <div className="text-[8px] font-bold text-gray-400 rotate-0 whitespace-nowrap leading-none scale-75 origin-bottom">
                                            {t('dashboard.project')}:{day.projects}
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="bg-white p-6 border-4 border-black shadow-hard-lg">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        {(!stats?.tag_stats || stats.tag_stats.length === 0) && (
                            <div className="text-gray-400 font-bold italic border-2 border-dashed border-gray-300 p-4 w-full text-center">{t('dashboard.no_tags')}</div>
                        )}
                    </div>
                </div>
            </div>
